...
{
    // это общий перовоначалльный скрипт, который был заменен на отдельные скрипты MoveAndTurn, DriftButtons, DriftSlider, TurnDriftSlider. В дальрнейше можно удалить за ненадобностью
